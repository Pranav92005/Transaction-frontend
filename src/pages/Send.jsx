...
export  function Send() {
    ...
    function transaction(){
        axios.post("http://localhost:3000/api/v1/account/transfer",{amount:amount,to:id},{headers:{Authorization:"Bearer "+localStorage.getItem("token")}}).then((res)=>{
            ...
            alert("Transaction failed!  account balance may be low");
            navigate('/balance');})
    }
  return (
    <div>return <div class="flex justify-center h-screen bg-gray-100">
    <div className="h-full flex flex-col justify-center">
        ...
        >
            ...
            <div class="flex items-center space-x-4">
                ...
                <span class="text-2xl text-white">{name.toUpperCase()[0]}</span>
                </div>
